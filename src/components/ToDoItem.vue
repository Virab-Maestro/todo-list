...
import { defineEmits, defineProps, ref, computed, nextTick } from 'vue';

const emits = defineEmits(["item-deleted", "item-edited"]);
...
async function focusOnEditButton() {
  await nextTick();
